...
const ContactPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen text-white font-poppins ">
      <header
      className="min-h-[60vh] flex items-center justify-center text-center px-6 relative overflow-hidden"
    >
      <div
      ...
      <footer className="w-full p-10 text-center text-white bg-gradient-to-b from-gray-900 to-black">
        <div className="max-w-4xl mx-auto">
          ...
          <form className="p-6 mt-6 bg-[#1f1f1f] rounded-xl shadow-xl space-y-6" onSubmit={handleSubmit}>
  <div className="flex flex-col gap-4 md:flex-row">
    <input
      ...
      className="w-full p-3 text-white bg-[#2a2a2a] border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 placeholder-gray-400"
    />
    <input
      type="email"
      name="email"
