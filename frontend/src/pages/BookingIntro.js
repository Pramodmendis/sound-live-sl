    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-black px-4">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        >
          ...
          <p className="text-sm text-gray-200 mt-2 text-center">Rent high-quality gear for your sessions.</p>
        </div>

        {/* Booking Studios Card */}
        <div
          onClick={() => navigate("/bookingstudios")}
        ...
        >
          ...
          <p className="text-sm text-gray-200 mt-2 text-center">Reserve our top-tier studios for your recording.</p>
        </div>
      </div>
    </div>
  );
